...
export class SearchAgencyComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    super(actr, _commonIMService, RESOURCE.SEARCH, toastr, translateService, dialog);
  }
  ngOnInit() {
    this.columns = [
      { i18n: 'common.orderNumber', field: 'orderNumber' },
      { i18n: 'search-information.point-of-supply', field: 'name' },
      { i18n: 'customer.address', field: 'address' },
      { i18n: 'search-information.numberPhone', field: 'tel' },
      { i18n: 'search-information.location', field: 'location' }
    ];
    super.mapColumn();
    this.getListCity();
    this.searchAgency();
