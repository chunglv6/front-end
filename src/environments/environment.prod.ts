...
export const COMMOM_CONFIG = {
  ...
  CLIENT_ID: 'crm',
  CLIENT_SECRET: 'ca3f5f5b-ad99-4a5e-8125-a742e26761b6',
...
export const environment = {
  ...
  serverUrl: {
    // url server
    api: 'http://10.60.156.162:8989/api/v1',
    api_dmdc: 'http://10.60.156.161:8989/api/v1',
    api_settle: 'http://10.60.156.161:8081/api/v1',
    api_im: 'http://10.60.156.162:8888/api/v1',
    api_billing: 'http://10.60.156.161:8088/api/v1',
  },
  API_PATH: {
    BASE_API_PATH: '',
    /** =================== API Permissions =================== */
